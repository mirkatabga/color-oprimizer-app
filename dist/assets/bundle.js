...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "14d125b8e69e571c6439";
...
function (_Component) {
  ...
  _createClass(AddColorForm, [{
    ...
    value: function submit(e) {
      ...
      e.preventDefault();
      alert("New color: ".concat(_title.value, " ").concat(_color.value));
      _title.value = '';
      _color.value = "#000000";
...
var HomeView = function HomeView() {
  return React.createElement("div", null, React.createElement(_forms_add_color_form__WEBPACK_IMPORTED_MODULE_0__["default"], null));
};
